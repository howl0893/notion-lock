...
It uses AES encryption in Browser, no data is send to any server during encryption or decryption. All runs locally client browser memory :D
...
1. Add the URL https://howl0893.github.io/notion-lock as an embedded view on any page of Notion.
